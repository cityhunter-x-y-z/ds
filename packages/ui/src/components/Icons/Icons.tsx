...
export const CardVisaIcon: IconComponent = (props) => (
  <IconWrapper {...DEFAULT_ICON_PROPS} {...props}>
    <rect width="20" height="14" x="2" y="5" rx="2" />
    <line x1="2" y1="10" x2="22" y2="10" />
    <text x="12" y="16" textAnchor="middle" fontSize="8">VISA</text>
  </IconWrapper>
);

export const CardMastercardIcon: IconComponent = (props) => (
  <IconWrapper {...DEFAULT_ICON_PROPS} {...props}>
    <rect width="20" height="14" x="2" y="5" rx="2" />
    <line x1="2" y1="10" x2="22" y2="10" />
    <circle cx="9" cy="15" r="2" fill="red" />
    <circle cx="15" cy="15" r="2" fill="orange" />
  </IconWrapper>
);

export const CardAmexIcon: IconComponent = (props) => (
  <IconWrapper {...DEFAULT_ICON_PROPS} {...props}>
    <rect width="20" height="14" x="2" y="5" rx="2" />
    <line x1="2" y1="10" x2="22" y2="10" />
    <text x="12" y="16" textAnchor="middle" fontSize="7">AMEX</text>
  </IconWrapper>
);

export const CardDiscoverIcon: IconComponent = (props) => (
  <IconWrapper {...DEFAULT_ICON_PROPS} {...props}>
    <rect width="20" height="14" x="2" y="5" rx="2" />
    <line x1="2" y1="10" x2="22" y2="10" />
    <text x="12" y="16" textAnchor="middle" fontSize="6">DISCOVER</text>
  </IconWrapper>
);
...
export const ICON_REGISTRY = {
  ...
  'card-visa': CardVisaIcon,
  'card-mastercard': CardMastercardIcon,
  'card-amex': CardAmexIcon,
  'card-discover': CardDiscoverIcon,
} as const;
